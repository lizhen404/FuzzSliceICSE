...
int test_uint64_t_eq(const char *file, int line, const char *s1, const char *s2, const uint64_t t1, const uint64_t t2) { if (t1 == t2) return 1; test_fail_message(((void*)0), file, line, "uint64_t", s1, s2, "==", "[%llu] compared to [%llu]", (unsigned long long)t1, (unsigned long long)t2); return 0; }
